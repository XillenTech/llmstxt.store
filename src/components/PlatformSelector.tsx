  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      ...
      <p className="text-gray-600 mb-6">
        Select your eCommerce platform to automatically configure common
        settings.
      </p>
      ...
      <div className="grid grid-cols-2 gap-4">
        {platforms.map((platform) => (
          <button
            ...
            onClick={() =>
              onPlatformSelect(
                selectedPlatform === platform.id ? "" : platform.id
              )
            }
            className={`
      ...
      {selectedPlatform && (
        <div className="mt-4 p-4 bg-blue-50 rounded-lg">
          <p className="text-sm text-blue-800">
            ✓ Platform-specific paths have been automatically configured for{" "}
